// FUNCIONAMIENTO DE TODAS LAS RUTAS DE extintores
...
module.exports = {
  ...
  crear: async (req, res) => {
    ...
    update: async (req, res) => {
        const extintorId = req.params.id; // Suponiendo que el ID del usuario a actualizar se pasa como parte de la URL.
        ...
        try {
          // Busca el extintor que se va a actualizar
